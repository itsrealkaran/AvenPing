...
export default function Sidebar({
  ...
  return (
    <TooltipProvider>
      <div
        className={cn(
          "flex flex-col h-screen border-r border-gray-200 sticky top-0 overflow-y-auto transition-all duration-300",
      ...
      >
        ...
        <button
          ...
          className="p-2 mx-4 mb-2 hover:bg-gray-100 rounded-md"
        >
