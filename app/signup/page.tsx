...
function SignupContent() {
  ...
  const [selectedPlanForPayment, setSelectedPlanForPayment] =
    useState<any>(null);
  const [planPeriodForPayment, setPlanPeriodForPayment] = useState<
    "month" | "year"
  >("year");
  const [regionForPayment, setRegionForPayment] = useState<
    "US" | "IND" | "ASIA"
  >("US");
  ...
  const checkWhatsAppStatus = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const isConnected =
          data.userData?.whatsappAccount?.phoneNumbers?.length > 0;
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 transition-all duration-200 text-gray-900 placeholder-gray-400 pr-12"
        ...
        return (
          <div className="min-h-[260px] flex flex-col justify-center space-y-6">
            <div className="text-center">
              ...
              {whatsappStatus.isConnected && (
                <p className="text-gray-600">
                  Great! Your WhatsApp is already connected. You can proceed to
                  the dashboard.
                </p>
              )}
            </div>
